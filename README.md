# docs
BCDevExchange artefacts including documents, templates, a wiki (deprecated) and other useful things.
...
Index for Discussion folder content (copied from discussion_index.md).
